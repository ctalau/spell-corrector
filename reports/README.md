...
| 10 | Serving throughput of the quantized 0.8B on one RTX 3090 | completed | **420 corrections/s** at p50 0.304 s, $0.000145/1,000; int8 *activations* are the win, int4 weights are worth nothing | [10-08b-3090-throughput](experiments/10-08b-3090-throughput/README.md) |
